...
<html>
    ...
    <body style="-webkit-text-size-adjust:none;background-color:#fff;width:650px;font-family:Open-sans, sans-serif;color:#555454;font-size:13px;line-height:18px;margin:auto">
        <table class="table table-mail" style="width:100%;margin-top:10px;-moz-box-shadow:0 0 5px #afafaf;-webkit-box-shadow:0 0 5px #afafaf;-o-box-shadow:0 0 5px #afafaf;box-shadow:0 0 5px #afafaf;filter:progid:DXImageTransform.Microsoft.Shadow(color=#afafaf,Direction=134,Strength=5)">
                ...
                <td align="center" style="padding:7px 0">
                    <table class="table" bgcolor="#ffffff" style="width:100%">
                        ...
                        <font size="2" face="Open-sans, sans-serif" color="#555454">
                            <span class="title" style="font-weight:500;font-size:28px;text-transform:uppercase;line-height:33px">Hello, <?php echo $client->get_fullname(); ?>,</span><br/>
                        </font>
            ...
            <tr>
                <td>
                    <span style="color:#777">We are pleased to inform you that your preferred disaster restoration company: Global Enterprise has
                        successfully set-up your mobile app access. You can now view the photos and read actual progress report of your property while the restoration process is being done.
...
<tr>
    <td class="space_footer" style="padding:0!important">
        <span style="color:#777; text-transform:capitalize;">Feel free to contact us if you have any questions about the app or the project.</span><br>
        <span class="subtitle" style="font-weight:500;font-size:16px;text-transform:capitalize;line-height:25px">Thank You</span>
    </td>
</tr>
<tr>
