                ...
                <td align="center" style="padding:7px 0">
                    <table class="table" bgcolor="#ffffff" style="width:100%">
                        ...
                        <font size="2" face="Open-sans, sans-serif" color="#555454">
                            <span class="title" style="font-weight:500;font-size:28px;text-transform:uppercase;line-height:33px">Hello, <?php echo ucfirst($client->get_fullname()); ?>,</span><br/>
                        </font>
                </td>
            </tr>
            <tr>
                    ...
                    <table class="table" style="width:100%">
                        ...
                        <font size="2" face="Open-sans, sans-serif" color="#555454">
                            ...
                            <span style="color:#777">
                                ...
                                <span style="color:#333"><strong>New Password: </strong></span> <?php echo $password; ?> <br />
                            </span>
                        </font>
                </td>
                <td width="10" style="padding:7px 0">&nbsp;</td>
...
<tr>
    <td class="space_footer" style="padding:0!important"><span class="subtitle" style="font-weight:500;font-size:16px;text-transform:capitalize;line-height:25px">Thank You</span></td>
</tr>
<tr>
